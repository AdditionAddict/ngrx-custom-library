...
/**
 * Default options for NxaEntityDispatcher behavior
 ...
 */
@Injectable()
export class NxaEntityDispatcherDefaultOptions {
    ...
    /** True if entities in a cache NxaSaveEntities request are saved optimistically; false if saved pessimistically. */
    optimisticNxaSaveEntities = false;
}